...
int staff_login::login()
{
	...
	for(int k=0;k<20;k++)
	{
		...
		while(1)
		{
			...
			switch(u)
			{
				case 1:s1.complaintbox();
						 break;
				case 2:s1.notice();
						break;
				case 3:s1.allot_staffr();
						break;
				case 4:system("cls");
						cout<<"\n\n\n\n\n\n\n           LOADING PLEASE WAIT ... ";
						Sleep(500);
...
int register_now::instructionsform() 
{
	...
	cin>>a;
		...
		{
			cout<<"sorry,You have to be accept this.....";
			Sleep(1000);
			system("cls");
		}
}
...
int register_now::confirmform()
{
   ...
   /* fil2.seekg(0,ios::end);
    ...
    while(fil2)
    {
    	...
    	int a;
    	Sleep(400);
    	cout<<endl<<endl<<"    Enter any number to return back to main menu :";
    	getch();
    	return 1;
	}
...
int main() 
{
	...
	for(int i=0;i<1;i++)
    {
    	...
    	for (x=40;x>1;x--)  
   		{
    	  gotoXY(x,y);
    	  cout << "Thanks to all the Staff and our friends who helped in development of this program";
    	  Sleep(100);
    	  gotoXY(x,y); 
		  cout << "                                                         ";
		     cout<<"                                            "; 
  		}
  		cout <<endl<<"       Thanks to all the Staff and our friends who helped in development of this program"<<endl;
	}
   register_now r1;
   staff_login s1;
   student_login s2;
